...
- [ ] Run the migrations **in order**, via `supabase db push` or pasted
      ...
      4. `supabase/migrations/0004_security_and_subscription_hardening.sql` —
         security hardening and one-subscription-per-user enforcement.
      5. `supabase/migrations/0005_final_production_hardening.sql` — final
         profile/proof security hardening and storage cleanup permissions.
