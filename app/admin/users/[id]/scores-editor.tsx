  ...
  return (
    <div className="panel space-y-4 p-5">
      <div className="flex items-center justify-between">
        <h2 className="font-display text-lg italic text-paper">Scores</h2>
        <span className="score-num text-paper/50">{scores.length} / 5 kept</span>
      </div>
      ...
      <ul>
            ...
            {editingId === s.id ? (
              ...
              <>
                <div className="flex items-center gap-4">
                  <span className="score-num w-10 text-paper">{s.score}</span>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={isPending}
                    className="text-xs text-flag-soft underline underline-offset-2"
                  >
                    Delete
                  </button>
                </div>
        ...
        {sorted.length === 0 && (
          <li className="py-4 text-center text-sm text-paper/40">No scores entered yet.</li>
        )}
      </ul>
